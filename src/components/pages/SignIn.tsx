                ...
                <div className="mt-8 space-y-6">
                    ...
                    <div className="text-center">
                        <button
                            ...
                            className={`font-medium text-brand-600 hover:text-brand-500 dark:text-brand-400 text-sm bg-transparent border-none cursor-pointer flex items-center justify-center gap-2 mx-auto tap-feedback ${loading ? 'opacity-50 cursor-wait' : ''}`}
                        >
                            {loading && (
                            ...
                            {loading ? 'Signing in...' : 'Go to Dashboard (Guest Mode)'}
                        </button>
                    </div>
                </div>
            </div>
